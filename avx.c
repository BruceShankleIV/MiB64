...
void AvxCompareEqualWordRegToReg128(BYTE** code, int Dest, int Src1, int Src2) {
	BYTE x86Command = 0;
	BYTE x86Src1 = 0;

	RSP_CPU_Message("      vpcmpeqw %s, %s, %s", sse_Name(Dest), sse_Name(Src1), sse_Name(Src2));
...
void AvxCompareGreaterWordRegToReg128(BYTE** code, int Dest, int Src1, int Src2) {
	...
	RSP_CPU_Message("      vpcmpgtw %s, %s, %s", sse_Name(Dest), sse_Name(Src1), sse_Name(Src2));
...
void AvxVPAddswRegToReg128(BYTE** code, int Dest, int Src1, int Src2) {
	BYTE x86Command = 0;
	BYTE x86Src1 = 0;

	RSP_CPU_Message("      vpaddsw %s, %s, %s", sse_Name(Dest), sse_Name(Src1), sse_Name(Src2));
...
void AvxVPandRegToReg128(BYTE** code, int Dest, int Src1, int Src2) {
	...
	RSP_CPU_Message("      vpand %s, %s, %s", sse_Name(Dest), sse_Name(Src1), sse_Name(Src2));
...
void AvxVPandRegToReg256(BYTE** code, int Dest, int Src1, int Src2) {
	...
	RSP_CPU_Message("      vpand %s, %s, %s", avx_Name(Dest), avx_Name(Src1), avx_Name(Src2));

	switch (Src1) {
	case x86_XMM0: x86Src1 = 0xfd; break;
	case x86_XMM1: x86Src1 = 0xf5; break;
	case x86_XMM2: x86Src1 = 0xed; break;
	case x86_XMM3: x86Src1 = 0xe5; break;
	case x86_XMM4: x86Src1 = 0xdd; break;
	case x86_XMM5: x86Src1 = 0xd5; break;
	case x86_XMM6: x86Src1 = 0xcd; break;
	case x86_XMM7: x86Src1 = 0xc5; break;
	}
	switch (Dest) {
	case x86_XMM0: x86Command = 0 << 3; break;
	case x86_XMM1: x86Command = 1 << 3; break;
...
void AvxVPBlendvbRegToReg128(BYTE** code, int Dest, int Src1, int Src2, int Src3Mask) {
	BYTE x86Command = 0;
	BYTE x86Src1 = 0;

	RSP_CPU_Message("      vpblendvb %s, %s, %s, %s", sse_Name(Dest), sse_Name(Src1), sse_Name(Src2), sse_Name(Src3Mask));
...
void AvxVPSrlwRegToReg128Immed(BYTE** code, int Dest, int Src, BYTE Immed) {
	...
	RSP_CPU_Message("      vpsrlw %s, %s, %i", sse_Name(Dest), sse_Name(Src), Immed);
...
void AvxVPSubdRegToReg256(BYTE** code, int Dest, int Src1, int Src2) {
	BYTE x86Command = 0;
	BYTE x86Src1 = 0;

	RSP_CPU_Message("      vpsubd %s, %s, %s", avx_Name(Dest), avx_Name(Src1), avx_Name(Src2));
...
void AvxVPSubwRegToReg128(BYTE** code, int Dest, int Src1, int Src2) {
	BYTE x86Command = 0;
	BYTE x86Src1 = 0;

	RSP_CPU_Message("      vpsubw %s, %s, %s", sse_Name(Dest), sse_Name(Src1), sse_Name(Src2));
