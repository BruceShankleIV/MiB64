...
void Sse2MoveDWordVariableToReg(BYTE** code, int Dest, void* Variable, char* VariableName) {
	...
	RSP_CPU_Message("      movd %s, dword ptr %s", sse_Name(Dest), VariableName);
...
void Sse2MoveRegToDWordReg(BYTE** code, int Dest, int Source) {
	...
	RSP_CPU_Message("      movd %s, %s", x86_Name(Dest), sse_Name(Source));
	...
	switch (Dest) {
	case x86_EAX: x86Command |= 0; break;
	case x86_ECX: x86Command |= 1; break;
	case x86_EDX: x86Command |= 2; break;
	case x86_EBX: x86Command |= 3; break;
	case x86_ESP: x86Command |= 4; break;
	case x86_EBP: x86Command |= 5; break;
	case x86_ESI: x86Command |= 6; break;
	case x86_EDI: x86Command |= 7; break;
	}
	PUTDST8(*code, 0x66);
	PUTDST16(*code, 0x7e0f);
	PUTDST8(*code, 0xC0 | x86Command);
...
void Sse2PaddswRegToReg(BYTE** code, int Dest, int Source) {
	...
	RSP_CPU_Message("      paddsw %s, %s", sse_Name(Dest), sse_Name(Source));
...
void Sse2PandnVariableToReg(BYTE** code, int Dest, void* Variable, char* VariableName) {
	...
	RSP_CPU_Message("      pandn %s, xmmword ptr %s", sse_Name(Dest), VariableName);
...
void Sse2PmulhuwRegToReg(BYTE** code, int Dest, int Source) {
	...
	RSP_CPU_Message("      pmulhuw %s, %s", sse_Name(Dest), sse_Name(Source));
...
void Sse2PmulhuwVariableToReg(BYTE** code, int Dest, void* Variable, char* VariableName) {
	...
	RSP_CPU_Message("      pmulhuw %s, xmmword ptr %s", sse_Name(Dest), VariableName);
...
void Sse2PsubdRegToReg(BYTE** code, int Dest, int Source) {
	...
	RSP_CPU_Message("      psubd %s, %s", sse_Name(Dest), sse_Name(Source));
...
void Sse2PsubswRegToReg(BYTE** code, int Dest, int Source) {
	...
	RSP_CPU_Message("      psubsw %s, %s", sse_Name(Dest), sse_Name(Source));
...
void Sse2PsubuswRegToReg(BYTE** code, int Dest, int Source) {
	...
	RSP_CPU_Message("      psubusw %s, %s", sse_Name(Dest), sse_Name(Source));
...
void Sse2PsubwRegToReg(BYTE** code, int Dest, int Source) {
	...
	RSP_CPU_Message("      psubw %s, %s", sse_Name(Dest), sse_Name(Source));
...
void Ssse3PHorizontalAddRegToReg(BYTE** code, int Dest, int Source) {
	...
	RSP_CPU_Message("      phaddw %s, %s", sse_Name(Dest), sse_Name(Source));
...
void Sse41PBlendRegToRegWithXMM0Mask(BYTE** code, int Dest, int Source) {
	...
	RSP_CPU_Message("      pblendvb %s, %s, xmm0", sse_Name(Dest), sse_Name(Source));
