...
static BOOL Compile_Vector_VMADL_SSE2(BOOL writeToVectorDest, BOOL writeToAccum) {
	char Reg[256];
...
static BOOL Compile_Vector_VMADL_AVX(BOOL writeToVectorDest, BOOL writeToAccum) {
	char Reg[256];
...
void CompileRsp_Vector_VMADL ( void ) {
	...
	if (bWriteToDest == TRUE) {
		...
		Push(&RspRecompPos, x86_EBP);
		MoveConstToX86reg(&RspRecompPos, 0x0000FFFF, x86_EBP);
	}
	...
	for (count = 0; count < 8; count++) {
		...
		ShiftRightUnsignImmed(&RspRecompPos, x86_EAX, 16);
		if(bWriteToAccum == TRUE && bWriteToDest == FALSE) {
			sprintf(Reg, "RSP_ACCUM_LOW.UHW[%d]", el);
			AddX86RegToVariableHalf(&RspRecompPos, &RSP_ACCUM_LOW.UHW[el], Reg, x86_EAX);
			sprintf(Reg, "RSP_ACCUM_MID.UHW[%d]", el);
			AdcConstToVariableHalf(&RspRecompPos, &RSP_ACCUM_MID.UHW[el], Reg, 0);
			sprintf(Reg, "RSP_ACCUM_HIGH.UHW[%d]", el);
			AdcConstToVariableHalf(&RspRecompPos, &RSP_ACCUM_HIGH.UHW[el], Reg, 0);
		} else {
			sprintf(Reg, "RSP_ACCUM_LOW.UHW[%d]", el);
			MoveZxVariableToX86regHalf(&RspRecompPos, &RSP_ACCUM_LOW.UHW[el], Reg, x86_ECX);
			AddX86RegToX86RegHalf(&RspRecompPos, x86_EAX, x86_ECX);
			sprintf(Reg, "RSP_ACCUM_MID.UHW[%d]", el);
			MoveZxVariableToX86regHalf(&RspRecompPos, &RSP_ACCUM_MID.UHW[el], Reg, x86_ECX);
			sprintf(Reg, "RSP_ACCUM_HIGH.UHW[%d]", el);
			MoveZxVariableToX86regHalf(&RspRecompPos, &RSP_ACCUM_HIGH.UHW[el], Reg, x86_EDX);
			
			AdcConstToX86RegHalf(&RspRecompPos, x86_ECX, 0);
			AdcConstToX86RegHalf(&RspRecompPos, x86_EDX, 0);

			if(bWriteToAccum == TRUE) {
				sprintf(Reg, "RSP_ACCUM_LOW.UHW[%d]", el);
				MoveX86regHalfToVariable(&RspRecompPos, x86_EAX, &RSP_ACCUM_LOW.UHW[el], Reg);
				sprintf(Reg, "RSP_ACCUM_MID.UHW[%d]", el);
				MoveX86regHalfToVariable(&RspRecompPos, x86_ECX, &RSP_ACCUM_MID.UHW[el], Reg);
				sprintf(Reg, "RSP_ACCUM_HIGH.UHW[%d]", el);
				MoveX86regHalfToVariable(&RspRecompPos, x86_EDX, &RSP_ACCUM_HIGH.UHW[el], Reg);
			}
		}
		...
		if (bWriteToDest != FALSE) {
			ShiftLeftSignImmed(&RspRecompPos, x86_EDX, 16);
			OrX86RegToX86Reg(&RspRecompPos, x86_ECX, x86_EDX);
			XorX86RegToX86Reg(&RspRecompPos, x86_EDX, x86_EDX);

			CompX86RegToX86Reg(&RspRecompPos, x86_ECX, x86_ESI);
			CondMoveGreater(&RspRecompPos, x86_EAX, x86_EBP);
			CompX86RegToX86Reg(&RspRecompPos, x86_ECX, x86_EDI);
			CondMoveLess(&RspRecompPos, x86_EAX, x86_EDX);
...
static BOOL Compile_Vector_VMADM_SSE2(BOOL writeToVectorDest, BOOL writeToAccum) {
	char Reg[256];
	...
	SseMoveRegToReg(&RspRecompPos, x86_XMM4, x86_XMM3, SseType_QuadWord, TRUE);
	Sse2PaddwRegToReg(&RspRecompPos, x86_XMM3, x86_XMM2);
	...
	Sse2PadduswRegToReg(&RspRecompPos, x86_XMM4, x86_XMM2);
	Sse2CompareEqualWordRegToReg(&RspRecompPos, x86_XMM3, x86_XMM4);
	...
	// add carry
	Sse2MoveSxWordRegToDWordReg(&RspRecompPos, x86_XMM6, x86_XMM3, IsSse41Enabled);
	Sse2PadddRegToReg(&RspRecompPos, x86_XMM4, x86_XMM6);
	Sse2ShuffleDWordsRegToReg(&RspRecompPos, x86_XMM3, x86_XMM3, _MMX_SHUFFLE(3, 2, 3, 2));
	Sse2MoveSxWordRegToDWordReg(&RspRecompPos, x86_XMM3, x86_XMM3, IsSse41Enabled);
	Sse2PadddRegToReg(&RspRecompPos, x86_XMM5, x86_XMM3);

	// add high mul
	Sse2MoveSxWordRegToDWordReg(&RspRecompPos, x86_XMM6, x86_XMM0, IsSse41Enabled);
	Sse2PadddRegToReg(&RspRecompPos, x86_XMM4, x86_XMM6);
	Sse2ShuffleDWordsRegToReg(&RspRecompPos, x86_XMM0, x86_XMM0, _MMX_SHUFFLE(3, 2, 3, 2));
	Sse2MoveSxWordRegToDWordReg(&RspRecompPos, x86_XMM0, x86_XMM0, IsSse41Enabled);
	Sse2PadddRegToReg(&RspRecompPos, x86_XMM5, x86_XMM0);
	...
	if (writeToVectorDest) {
		Sse2PackSignedDWordRegToWordReg(&RspRecompPos, x86_XMM4, x86_XMM5);
		sprintf(Reg, "RSP_Vect[%i]", RSPOpC.OP.V.vd);
		SseMoveAlignedRegToVariable(&RspRecompPos, x86_XMM4, &RSP_Vect[RSPOpC.OP.V.vd].UHW[0], Reg, SseType_QuadWord, TRUE);
	}

	return TRUE;
}

static BOOL Compile_Vector_VMADM_AVX(BOOL writeToVectorDest, BOOL writeToAccum) {
	char Reg[256];
	...
	// add carry
	AvxVPMovesxWordReg128ToDwordReg256(&RspRecompPos, x86_YMM6, x86_XMM3);
	...
	if (writeToVectorDest) {
		...
		AvxVPackSignedDWordRegToWordReg128(&RspRecompPos, x86_XMM4, x86_XMM4, x86_XMM5);
		sprintf(Reg, "RSP_Vect[%i]", RSPOpC.OP.V.vd);
		SseMoveAlignedRegToVariable(&RspRecompPos, x86_XMM4, &RSP_Vect[RSPOpC.OP.V.vd].UHW[0], Reg, SseType_QuadWord, TRUE);
	}
...
void CompileRsp_Vector_VMADM ( void ) {
	...
	if (bWriteToDest) {
		...
		sprintf(Reg, "RSP_Vect[%i].HW[0]", RSPOpC.OP.V.vt);
		MoveOffsetToX86reg(&RspRecompPos, (DWORD)&RSP_Vect[RSPOpC.OP.V.vt].HW[0], Reg, x86_ECX);
	}
	...
	for (count = 0; count < 8; count++) {
		...
		sprintf(Reg, "RSP_Vect[%i].HW[%i]", RSPOpC.OP.V.vs, el);
		MoveSxX86RegPtrDispToX86RegHalf(&RspRecompPos, x86_EBP, (BYTE)(el * 2), x86_EAX);

		if (bOptimize == FALSE) {
			if (bWriteToDest == TRUE) {
				sprintf(Reg, "RSP_Vect[%i].HW[%i]", RSPOpC.OP.V.vt, del);
				MoveZxVariableToX86regHalf(&RspRecompPos, &RSP_Vect[RSPOpC.OP.V.vt].HW[del], "RSP_Vect[RSPOpC.rt].HW[del]", x86_EBX);
			} else {
				MoveZxX86RegPtrDispToX86RegHalf(&RspRecompPos, x86_ECX, (BYTE)(del * 2), x86_EBX);
			}
		}
		...
		if (bWriteToAccum == TRUE && bWriteToDest == FALSE) {
			...
			AddX86RegToVariableHalf(&RspRecompPos, &RSP_ACCUM_LOW.UHW[el], Reg, x86_EAX);
			sprintf(Reg, "RSP_ACCUM_MID.UHW[%d]", el);
			AdcX86RegToVariableHalf(&RspRecompPos, &RSP_ACCUM_MID.UHW[el], Reg, x86_ESI);
			sprintf(Reg, "RSP_ACCUM_HIGH.UHW[%d]", el);
			AdcX86RegToVariableHalf(&RspRecompPos, &RSP_ACCUM_HIGH.UHW[el], Reg, x86_EDX);
		} else {
			MoveX86RegToX86Reg(&RspRecompPos, x86_EAX, x86_EDX);
			ShiftRightSignImmed(&RspRecompPos, x86_EAX, 16);
			sprintf(Reg, "RSP_ACCUM_LOW.UHW[%d]", el);
			if (bWriteToAccum == TRUE) {
				AddX86RegToVariableHalf(&RspRecompPos, &RSP_ACCUM_LOW.UHW[el], Reg, x86_EDX);
			} else {
				AddVariableToX86regHalf(&RspRecompPos, x86_EDX, &RSP_ACCUM_LOW.UHW[el], Reg);
			}
			AdcConstToX86Reg(&RspRecompPos, x86_EAX, 0);

			sprintf(Reg, "RSP_ACCUM_HIGH.UHW[%d]", el);
			MoveVariableToX86regHalf(&RspRecompPos, &RSP_ACCUM_HIGH.UHW[el], Reg, x86_EDX);
			ShiftLeftSignImmed(&RspRecompPos, x86_EDX, 16);
			sprintf(Reg, "RSP_ACCUM_MID.UHW[%d]", el);
			MoveVariableToX86regHalf(&RspRecompPos, &RSP_ACCUM_MID.UHW[el], Reg, x86_EDX);
			AddX86RegToX86Reg(&RspRecompPos, x86_EAX, x86_EDX);
...
static BOOL Compile_Vector_VMADN_SSE2(BOOL writeToVectorDest, BOOL writeToAccum) {
	char Reg[256];
	...
	/* compute carry in xmm4 */
	Sse2PadduswRegToReg(&RspRecompPos, x86_XMM4, x86_XMM2);
	Sse2CompareEqualWordRegToReg(&RspRecompPos, x86_XMM4, x86_XMM3);
	Sse2CompareEqualDWordRegToReg(&RspRecompPos, x86_XMM7, x86_XMM7);
	Sse2PxorRegToReg(&RspRecompPos, x86_XMM4, x86_XMM7);
	Sse2PsrlwImmed(&RspRecompPos, x86_XMM4, 15);
	...
	// 5 and 6 are high|mid
	SseMoveAlignedVariableToReg(&RspRecompPos, &RSP_ACCUM_HIGH.UHW[0], "RSP_ACCUM_HIGH", x86_XMM7, SseType_QuadWord, TRUE);
	SseMoveAlignedVariableToReg(&RspRecompPos, &RSP_ACCUM_MID.UHW[0], "RSP_ACCUM_MID", x86_XMM5, SseType_QuadWord, TRUE);
	SseMoveRegToReg(&RspRecompPos, x86_XMM6, x86_XMM5, SseType_QuadWord, TRUE);
	Sse2PunpckHighWordsRegToReg(&RspRecompPos, x86_XMM6, x86_XMM7);
	Sse2PunpckLowWordsRegToReg(&RspRecompPos, x86_XMM5, x86_XMM7);

	// add carry
	Sse2MoveSxWordRegToDWordReg(&RspRecompPos, x86_XMM7, x86_XMM4, IsSse41Enabled);
	Sse2PadddRegToReg(&RspRecompPos, x86_XMM5, x86_XMM7);
	Sse2ShuffleDWordsRegToReg(&RspRecompPos, x86_XMM4, x86_XMM4, _MMX_SHUFFLE(3, 2, 3, 2));
	Sse2MoveSxWordRegToDWordReg(&RspRecompPos, x86_XMM4, x86_XMM4, IsSse41Enabled);
	Sse2PadddRegToReg(&RspRecompPos, x86_XMM6, x86_XMM4);

	// add high mul
	Sse2MoveSxWordRegToDWordReg(&RspRecompPos, x86_XMM7, x86_XMM1, IsSse41Enabled);
	Sse2PadddRegToReg(&RspRecompPos, x86_XMM5, x86_XMM7);
	Sse2ShuffleDWordsRegToReg(&RspRecompPos, x86_XMM1, x86_XMM1, _MMX_SHUFFLE(3, 2, 3, 2));
	Sse2MoveSxWordRegToDWordReg(&RspRecompPos, x86_XMM1, x86_XMM1, IsSse41Enabled);
	Sse2PadddRegToReg(&RspRecompPos, x86_XMM6, x86_XMM1);

	if (writeToAccum) {
		SseMoveRegToReg(&RspRecompPos, x86_XMM0, x86_XMM5, SseType_QuadWord, TRUE);
		SseMoveRegToReg(&RspRecompPos, x86_XMM1, x86_XMM6, SseType_QuadWord, TRUE);
		Sse2PslldImmed(&RspRecompPos, x86_XMM0, 16);
		Sse2PslldImmed(&RspRecompPos, x86_XMM1, 16);
		Sse2PsradImmed(&RspRecompPos, x86_XMM0, 16);
		Sse2PsradImmed(&RspRecompPos, x86_XMM1, 16);
		Sse2PackSignedDWordRegToWordReg(&RspRecompPos, x86_XMM0, x86_XMM1);
		SseMoveAlignedRegToVariable(&RspRecompPos, x86_XMM0, &RSP_ACCUM_MID.UHW[0], "RSP_ACCUM_MID", SseType_QuadWord, TRUE);
	...
	if (writeToVectorDest) {
		...
		Sse2PslldImmed(&RspRecompPos, x86_XMM0, 15);
		SseMoveRegToReg(&RspRecompPos, x86_XMM1, x86_XMM0, SseType_QuadWord, TRUE);
		Sse2CompareGreaterDWordRegToReg(&RspRecompPos, x86_XMM0, x86_XMM5);
		Sse2CompareGreaterDWordRegToReg(&RspRecompPos, x86_XMM1, x86_XMM6);
		Sse2PackSignedDWordRegToWordReg(&RspRecompPos, x86_XMM0, x86_XMM1);
		Sse2PandnRegToReg(&RspRecompPos, x86_XMM0, x86_XMM3);

		Sse2CompareEqualDWordRegToReg(&RspRecompPos, x86_XMM7, x86_XMM7);
		Sse2PsrldImmed(&RspRecompPos, x86_XMM7, 17);
		Sse2CompareGreaterDWordRegToReg(&RspRecompPos, x86_XMM5, x86_XMM7);
		Sse2CompareGreaterDWordRegToReg(&RspRecompPos, x86_XMM6, x86_XMM7);
		Sse2PackSignedDWordRegToWordReg(&RspRecompPos, x86_XMM5, x86_XMM6);
		Sse2PorRegToReg(&RspRecompPos, x86_XMM0, x86_XMM5);
...
static BOOL Compile_Vector_VMADN_AVX(BOOL writeToVectorDest, BOOL writeToAccum) {
	char Reg[256];
	...
	SseMoveAlignedVariableToReg(&RspRecompPos, &RSP_ACCUM_HIGH.UHW[0], "RSP_ACCUM_HIGH", x86_XMM7, SseType_QuadWord, TRUE);
	SseMoveAlignedVariableToReg(&RspRecompPos, &RSP_ACCUM_MID.UHW[0], "RSP_ACCUM_MID", x86_XMM5, SseType_QuadWord, TRUE);
	AvxVPunpckHighWordsRegToReg256(&RspRecompPos, x86_YMM6, x86_YMM5, x86_YMM7);
	AvxVPunpckLowWordsRegToReg256(&RspRecompPos, x86_YMM5, x86_YMM5, x86_YMM7);
	AvxVInserti128RegToReg(&RspRecompPos, x86_YMM5, x86_YMM5, x86_XMM6, TRUE);

	// add carry
	AvxVPMovesxWordReg128ToDwordReg256(&RspRecompPos, x86_YMM7, x86_XMM3);
	AvxVPAdddRegToReg256(&RspRecompPos, x86_YMM5, x86_YMM5, x86_YMM7);

	// add high mul
	AvxVPMovezxWordReg128ToDwordReg256(&RspRecompPos, x86_YMM0, x86_XMM0);
	AvxVPMovesxWordReg128ToDwordReg256(&RspRecompPos, x86_YMM1, x86_XMM1);
	AvxVPMulldRegToReg256(&RspRecompPos, x86_YMM0, x86_YMM0, x86_YMM1);
	AvxVPSradRegToReg256Immed(&RspRecompPos, x86_YMM0, x86_YMM0, 16);
	AvxVPAdddRegToReg256(&RspRecompPos, x86_YMM5, x86_YMM5, x86_YMM0);

	if (writeToAccum) {
		AvxVPSlldRegToReg256Immed(&RspRecompPos, x86_YMM6, x86_YMM5, 16);
		AvxVPSradRegToReg256Immed(&RspRecompPos, x86_YMM6, x86_YMM6, 16);
		AvxVExtracti128RegToReg(&RspRecompPos, x86_XMM7, x86_YMM6, TRUE);
		AvxVPackSignedDWordRegToWordReg128(&RspRecompPos, x86_XMM6, x86_XMM6, x86_XMM7);
		SseMoveAlignedRegToVariable(&RspRecompPos, x86_XMM6, &RSP_ACCUM_MID.UHW[0], "RSP_ACCUM_MID", SseType_QuadWord, TRUE);

		AvxVPSradRegToReg256Immed(&RspRecompPos, x86_YMM6, x86_YMM5, 16);
		AvxVExtracti128RegToReg(&RspRecompPos, x86_XMM7, x86_YMM6, TRUE);
		AvxVPackSignedDWordRegToWordReg128(&RspRecompPos, x86_XMM6, x86_XMM6, x86_XMM7);
		SseMoveAlignedRegToVariable(&RspRecompPos, x86_XMM6, &RSP_ACCUM_HIGH.UHW[0], "RSP_ACCUM_HIGH", SseType_QuadWord, TRUE);
	}
	...
	if (writeToVectorDest) {
		AvxCompareEqualDWordRegToReg256(&RspRecompPos, x86_YMM7, x86_YMM7, x86_YMM7);
		AvxVPSlldRegToReg256Immed(&RspRecompPos, x86_YMM0, x86_YMM7, 15);
		AvxCompareGreaterDWordRegToReg256(&RspRecompPos, x86_YMM0, x86_YMM0, x86_YMM5);
		AvxVExtracti128RegToReg(&RspRecompPos, x86_XMM1, x86_YMM0, TRUE);
		AvxVPackSignedDWordRegToWordReg128(&RspRecompPos, x86_XMM0, x86_XMM0, x86_XMM1);
		AvxVPandnRegToReg256(&RspRecompPos, x86_XMM4, x86_XMM0, x86_XMM4);

		AvxVPSrldRegToReg256Immed(&RspRecompPos, x86_YMM7, x86_YMM7, 17);
		AvxCompareGreaterDWordRegToReg256(&RspRecompPos, x86_YMM5, x86_YMM5, x86_YMM7);
		AvxVExtracti128RegToReg(&RspRecompPos, x86_XMM6, x86_YMM5, TRUE);
		AvxVPackSignedDWordRegToWordReg128(&RspRecompPos, x86_XMM5, x86_XMM5, x86_XMM6);
		AvxVPorRegToReg256(&RspRecompPos, x86_XMM4, x86_XMM4, x86_XMM5);
...
void CompileRsp_Vector_VMADN ( void ) {
	...
	if (TRUE == Compile_Vector_VMADN_AVX(bWriteToDest, bWriteToAccum)) {
		return;
	}

	if (TRUE == Compile_Vector_VMADN_SSE2(bWriteToDest, bWriteToAccum)) {
		return;
	}
	...
	for (count = 0; count < 8; count++) {
		...
		MoveZxX86RegPtrDispToX86RegHalf(&RspRecompPos, x86_EBP, (BYTE)(el * 2), x86_EAX); //vs
		...
		if (bWriteToAccum == TRUE && bWriteToDest == FALSE) {
			...
			AddX86RegToVariableHalf(&RspRecompPos, &RSP_ACCUM_LOW.UHW[el], Reg, x86_EAX);
			sprintf(Reg, "RSP_ACCUM_MID.UHW[%d]", el);
			AdcX86RegToVariableHalf(&RspRecompPos, &RSP_ACCUM_MID.UHW[el], Reg, x86_ECX);
			sprintf(Reg, "RSP_ACCUM_HIGH.UHW[%d]", el);
			AdcX86RegToVariableHalf(&RspRecompPos, &RSP_ACCUM_HIGH.UHW[el], Reg, x86_EDX);
		}
		else {
			...
			ShiftRightSignImmed(&RspRecompPos, x86_ECX, 16);
			sprintf(Reg, "RSP_ACCUM_LOW.UHW[%d]", el);
			AddVariableToX86regHalf(&RspRecompPos, x86_EAX, &RSP_ACCUM_LOW.UHW[el], Reg);
			sprintf(Reg, "RSP_ACCUM_MID.UHW[%d]", el);
			AdcVariableToX86regHalf(&RspRecompPos, x86_ECX, &RSP_ACCUM_MID.UHW[el], Reg);
			sprintf(Reg, "RSP_ACCUM_HIGH.UHW[%d]", el);
			AdcVariableToX86regHalf(&RspRecompPos, x86_EDX, &RSP_ACCUM_HIGH.UHW[el], Reg);
		...
		if (bWriteToDest == TRUE) {
			/* For compare (MID_HIGH) */
			ShiftLeftSignImmed(&RspRecompPos, x86_EDX, 16);
			MoveX86RegToX86RegHalf(&RspRecompPos, x86_ECX, x86_EDX);

			/* Weird eh */
			CompConstToX86reg(&RspRecompPos, x86_EDX, 0x7fff);
			CondMoveGreater(&RspRecompPos, x86_EAX, x86_ESI);
			CompConstToX86reg(&RspRecompPos, x86_EDX, (DWORD)-0x8000);
			CondMoveLess(&RspRecompPos, x86_EAX, x86_EDI);
...
static BOOL Compile_Vector_VMADH_SSE2(BOOL writeToVectorDest, BOOL writeToAccum) {
	char Reg[256];
	...
	SseMoveRegToReg(&RspRecompPos, x86_XMM2, x86_XMM1, SseType_QuadWord, TRUE);
	Sse2PmulhwRegToReg(&RspRecompPos, x86_XMM2, x86_XMM0);
	Sse2PmullwRegToReg(&RspRecompPos, x86_XMM1, x86_XMM0);

	SseMoveAlignedVariableToReg(&RspRecompPos, &RSP_ACCUM_MID.UHW[0], "RSP_ACCUM_MID", x86_XMM3, SseType_QuadWord, TRUE);
	SseMoveAlignedVariableToReg(&RspRecompPos, &RSP_ACCUM_HIGH.UHW[0], "RSP_ACCUM_HIGH", x86_XMM4, SseType_QuadWord, TRUE);

	SseMoveRegToReg(&RspRecompPos, x86_XMM5, x86_XMM3, SseType_QuadWord, TRUE);
	Sse2PaddwRegToReg(&RspRecompPos, x86_XMM3, x86_XMM1);
	if (writeToAccum) {
		SseMoveAlignedRegToVariable(&RspRecompPos, x86_XMM3, &RSP_ACCUM_MID.UHW[0], "RSP_ACCUM_MID", SseType_QuadWord, TRUE);
	}

	// compute carry in xmm5
	Sse2PadduswRegToReg(&RspRecompPos, x86_XMM5, x86_XMM1);
	Sse2CompareEqualDWordRegToReg(&RspRecompPos, x86_XMM6, x86_XMM6);
	Sse2CompareEqualWordRegToReg(&RspRecompPos, x86_XMM5, x86_XMM3);
	Sse2PandnRegToReg(&RspRecompPos, x86_XMM5, x86_XMM6);
	Sse2PsrlwImmed(&RspRecompPos, x86_XMM5, 15);

	Sse2PaddwRegToReg(&RspRecompPos, x86_XMM4, x86_XMM5);
	Sse2PaddwRegToReg(&RspRecompPos, x86_XMM4, x86_XMM2);
	if (writeToAccum) {
		SseMoveAlignedRegToVariable(&RspRecompPos, x86_XMM4, &RSP_ACCUM_HIGH.UHW[0], "RSP_ACCUM_HIGH", SseType_QuadWord, TRUE);
	}

	if (writeToVectorDest) {
		SseMoveRegToReg(&RspRecompPos, x86_XMM5, x86_XMM3, SseType_QuadWord, TRUE);
		Sse2PunpckLowWordsRegToReg(&RspRecompPos, x86_XMM3, x86_XMM4);
		Sse2PunpckHighWordsRegToReg(&RspRecompPos, x86_XMM5, x86_XMM4);
		Sse2PackSignedDWordRegToWordReg(&RspRecompPos, x86_XMM3, x86_XMM5);
...
static BOOL Compile_Vector_VMADH_AVX(BOOL writeToVectorDest, BOOL writeToAccum) {
	char Reg[256];
	...
	AvxVPAddwRegToReg128(&RspRecompPos, x86_XMM5, x86_XMM3, x86_XMM2);
	if (writeToAccum) {
		SseMoveAlignedRegToVariable(&RspRecompPos, x86_XMM5, &RSP_ACCUM_MID.UHW[0], "RSP_ACCUM_MID", SseType_QuadWord, TRUE);
	}

	// compute carry in xmm3
	Sse2PadduswRegToReg(&RspRecompPos, x86_XMM3, x86_XMM2);
	Sse2CompareEqualDWordRegToReg(&RspRecompPos, x86_XMM6, x86_XMM6);
	Sse2CompareEqualWordRegToReg(&RspRecompPos, x86_XMM3, x86_XMM5);
	Sse2PandnRegToReg(&RspRecompPos, x86_XMM3, x86_XMM6);
	Sse2PsrlwImmed(&RspRecompPos, x86_XMM3, 15);

	Sse2PaddwRegToReg(&RspRecompPos, x86_XMM4, x86_XMM3);
	Sse2PaddwRegToReg(&RspRecompPos, x86_XMM4, x86_XMM1);
	if (writeToAccum) {
		SseMoveAlignedRegToVariable(&RspRecompPos, x86_XMM4, &RSP_ACCUM_HIGH.UHW[0], "RSP_ACCUM_HIGH", SseType_QuadWord, TRUE);
	}

	if (writeToVectorDest) {
		AvxVPunpckHighWordsRegToReg128(&RspRecompPos, x86_XMM6, x86_XMM5, x86_XMM4);
		AvxVPunpckLowWordsRegToReg128(&RspRecompPos, x86_XMM7, x86_XMM5, x86_XMM4);
		Sse2PackSignedDWordRegToWordReg(&RspRecompPos, x86_XMM7, x86_XMM6);
...
void CompileRsp_Vector_VMADH ( void ) {
	...
	BOOL bOptimize = ((RSPOpC.OP.V.element & 0x0f) >= 8) ? TRUE : FALSE;
	BOOL bWriteToDest = WriteToVectorDest(RSPOpC.OP.V.vd, RspCompilePC);
	BOOL bWriteToAccum = WriteToAccum(Middle16BitAccum | High16BitAccum, RspCompilePC);
	...
	if (TRUE == Compile_Vector_VMADH_AVX(bWriteToDest, bWriteToAccum)) {
		return;
	}

	if (TRUE == Compile_Vector_VMADH_SSE2(bWriteToDest, bWriteToAccum)) {
		return;
	}
	...
	if (bWriteToDest == FALSE && bOptimize == TRUE) {
		...
		MoveX86RegToX86Reg(&RspRecompPos, x86_EAX, x86_EDX);
		ShiftRightSignImmed(&RspRecompPos, x86_EDX, 16);
		AddX86RegToVariableHalf(&RspRecompPos, &RSP_ACCUM_MID.UHW[0], "RSP_ACCUM_MID.UHW[0]", x86_EAX);
		AdcX86RegToVariableHalf(&RspRecompPos, &RSP_ACCUM_HIGH.UHW[0], "RSP_ACCUM_HIGH.UHW[0]", x86_EDX);

		MoveX86RegToX86Reg(&RspRecompPos, x86_ECX, x86_EDX);
		ShiftRightSignImmed(&RspRecompPos, x86_EDX, 16);
		AddX86RegToVariableHalf(&RspRecompPos, &RSP_ACCUM_MID.UHW[1], "RSP_ACCUM_MID.UHW[1]", x86_ECX);
		AdcX86RegToVariableHalf(&RspRecompPos, &RSP_ACCUM_HIGH.UHW[1], "RSP_ACCUM_HIGH.UHW[1]", x86_EDX);

		MoveX86RegToX86Reg(&RspRecompPos, x86_EDI, x86_EAX);
		MoveX86RegToX86Reg(&RspRecompPos, x86_ESI, x86_EDX);

		ShiftRightSignImmed(&RspRecompPos, x86_EAX, 16);
		ShiftRightSignImmed(&RspRecompPos, x86_EDX, 16);

		AddX86RegToVariableHalf(&RspRecompPos, &RSP_ACCUM_MID.UHW[2], "RSP_ACCUM_MID.UHW[2]", x86_EDI);
		AdcX86RegToVariableHalf(&RspRecompPos, &RSP_ACCUM_HIGH.UHW[2], "RSP_ACCUM_HIGH.UHW[2]", x86_EAX);
		AddX86RegToVariableHalf(&RspRecompPos, &RSP_ACCUM_MID.UHW[3], "RSP_ACCUM_MID.UHW[3]", x86_ESI);
		AdcX86RegToVariableHalf(&RspRecompPos, &RSP_ACCUM_HIGH.UHW[3], "RSP_ACCUM_HIGH.UHW[3]", x86_EDX);
		...
		MoveX86RegToX86Reg(&RspRecompPos, x86_EAX, x86_EDX);
		ShiftRightSignImmed(&RspRecompPos, x86_EDX, 16);
		AddX86RegToVariableHalf(&RspRecompPos, &RSP_ACCUM_MID.UHW[4], "RSP_ACCUM_MID.UHW[4]", x86_EAX);
		AdcX86RegToVariableHalf(&RspRecompPos, &RSP_ACCUM_HIGH.UHW[4], "RSP_ACCUM_HIGH.UHW[4]", x86_EDX);

		MoveX86RegToX86Reg(&RspRecompPos, x86_ECX, x86_EDX);
		ShiftRightSignImmed(&RspRecompPos, x86_EDX, 16);
		AddX86RegToVariableHalf(&RspRecompPos, &RSP_ACCUM_MID.UHW[5], "RSP_ACCUM_MID.UHW[5]", x86_ECX);
		AdcX86RegToVariableHalf(&RspRecompPos, &RSP_ACCUM_HIGH.UHW[5], "RSP_ACCUM_HIGH.UHW[5]", x86_EDX);
		...
		AddX86RegToVariableHalf(&RspRecompPos, &RSP_ACCUM_MID.UHW[6], "RSP_ACCUM_MID.UHW[6]", x86_EDI);
		AdcX86RegToVariableHalf(&RspRecompPos, &RSP_ACCUM_HIGH.UHW[6], "RSP_ACCUM_HIGH.UHW[6]", x86_EAX);
		AddX86RegToVariableHalf(&RspRecompPos, &RSP_ACCUM_MID.UHW[7], "RSP_ACCUM_MID.UHW[7]", x86_ESI);
		AdcX86RegToVariableHalf(&RspRecompPos, &RSP_ACCUM_HIGH.UHW[7], "RSP_ACCUM_HIGH.UHW[7]", x86_EDX);
		...
		for (count = 0; count < 8; count++) {
			...
			MoveSxX86RegPtrDispToX86RegHalf(&RspRecompPos, x86_EBP, (BYTE)(el * 2), x86_EAX); // vs
			...
			if (bOptimize == FALSE) {
				if (bWriteToDest == TRUE) {
					...
					MoveSxX86RegPtrDispToX86RegHalf(&RspRecompPos, x86_ECX, (BYTE)(del * 2), x86_EBX);
				}
			}
			...
			if (bWriteToAccum == TRUE && bWriteToDest == FALSE) {
				...
				ShiftRightSignImmed(&RspRecompPos, x86_EAX, 16);
				sprintf(Reg, "RSP_ACCUM_MID.UHW[%d]", el);
				AddX86RegToVariableHalf(&RspRecompPos, &RSP_ACCUM_MID.UHW[el], Reg, x86_EDX);
				sprintf(Reg, "RSP_ACCUM_HIGH.UHW[%d]", el);
				AdcX86RegToVariableHalf(&RspRecompPos, &RSP_ACCUM_HIGH.UHW[el], Reg, x86_EAX);
			} else {
				MoveX86RegToX86Reg(&RspRecompPos, x86_EAX, x86_EDX);
				ShiftRightSignImmed(&RspRecompPos, x86_EAX, 16);
				sprintf(Reg, "RSP_ACCUM_MID.UHW[%d]", el);
				AddVariableToX86regHalf(&RspRecompPos, x86_EDX, &RSP_ACCUM_MID.UHW[el], Reg);
				sprintf(Reg, "RSP_ACCUM_HIGH.UHW[%d]", el);
				AdcVariableToX86regHalf(&RspRecompPos, x86_EAX, &RSP_ACCUM_HIGH.UHW[el], Reg);
				
				if (bWriteToAccum == TRUE) {
					sprintf(Reg, "RSP_ACCUM_MID.UHW[%d]", el);
					MoveX86regHalfToVariable(&RspRecompPos, x86_EDX, &RSP_ACCUM_MID.UHW[el], Reg);
					sprintf(Reg, "RSP_ACCUM_HIGH.UHW[%d]", el);
					MoveX86regHalfToVariable(&RspRecompPos, x86_EAX, &RSP_ACCUM_HIGH.UHW[el], Reg);
				}
			}
			...
			if (bWriteToDest == TRUE) {
				ShiftLeftSignImmed(&RspRecompPos, x86_EAX, 16);
				MoveX86RegToX86RegHalf(&RspRecompPos, x86_EDX, x86_EAX);
				...
				MoveX86regHalfToX86regPointerDisp(&RspRecompPos, x86_EAX, x86_ECX, (BYTE)(el * 2)); // vd
			}
		}
		Pop(&RspRecompPos, x86_EBP);
	}
...
static BOOL Compile_Vector_VADD_MMX ( BOOL writeToFlag ) {
	char Reg[256];
	...
	if ((RSPOpC.OP.V.element & 15) >= 8) {
		RSP_Element2Mmx(x86_MM2);
		MmxPaddswRegToReg(&RspRecompPos, x86_MM0, x86_MM2);
		MmxPaddswRegToReg(&RspRecompPos, x86_MM1, x86_MM2);
	} else if ((RSPOpC.OP.V.element & 15) < 2) {
		sprintf(Reg, "RSP_Vect[%i].HW[0]", RSPOpC.OP.V.vt);
		MmxPaddswVariableToReg(&RspRecompPos, x86_MM0, &RSP_Vect[RSPOpC.OP.V.vt].HW[0], Reg);
		sprintf(Reg, "RSP_Vect[%i].HW[4]", RSPOpC.OP.V.vt);
		MmxPaddswVariableToReg(&RspRecompPos, x86_MM1, &RSP_Vect[RSPOpC.OP.V.vt].HW[4], Reg);
	} else {
		RSP_MultiElement2Mmx(x86_MM2, x86_MM3);
		MmxPaddswRegToReg(&RspRecompPos, x86_MM0, x86_MM2);
		MmxPaddswRegToReg(&RspRecompPos, x86_MM1, x86_MM3);
	}
...
static BOOL Compile_Vector_VADD_OnlyVec_SSE2(BOOL writeToFlag) {
	char Reg[256];
	...
	Sse2PaddswRegToReg(&RspRecompPos, x86_XMM0, x86_XMM1);
...
static BOOL Compile_Vector_VADD_SSE2(BOOL writeToVectorDest, BOOL writeToAccum, BOOL useFlag, BOOL writeToFlag) {
	char Reg[256];
	static VECTOR flagMask;
	static BOOL constInitialized = FALSE;

	if (!constInitialized) {
		for (int i = 0; i < 8; ++i) {
			flagMask.UHW[i] = 1 << (7-i);
		}
		constInitialized = TRUE;
	}
	...
	if (useFlag) {
		SseMoveAlignedVariableToReg(&RspRecompPos, &flagMask, "flagMask", x86_XMM7, SseType_QuadWord, TRUE);
		Sse2MoveDWordVariableToReg(&RspRecompPos, x86_XMM6, &RspVCO, "VCO");
		Sse2ShuffleLowWordsRegToReg(&RspRecompPos, x86_XMM6, x86_XMM6, _MMX_SHUFFLE(0, 0, 0, 0));
		Sse2ShuffleDWordsRegToReg(&RspRecompPos, x86_XMM6, x86_XMM6, _MMX_SHUFFLE(1, 0, 1, 0));
		Sse2PandRegToReg(&RspRecompPos, x86_XMM6, x86_XMM7);
		Sse2PxorRegToReg(&RspRecompPos, x86_XMM7, x86_XMM7);
		Sse2CompareGreaterWordRegToReg(&RspRecompPos, x86_XMM6, x86_XMM7);
		Sse2PsrlwImmed(&RspRecompPos, x86_XMM6, 15);
	}
	...
	if (writeToAccum) {
		...
		Sse2PaddwRegToReg(&RspRecompPos, vsreg, x86_XMM1);

		if (useFlag) {
			Sse2PaddwRegToReg(&RspRecompPos, vsreg, x86_XMM6);
		}

		SseMoveAlignedRegToVariable(&RspRecompPos, vsreg, &RSP_ACCUM_LOW.UHW[0], "RSP_ACCUM_LOW", SseType_QuadWord, TRUE);
	}

	if (writeToVectorDest) {	
		if (useFlag) {
			Sse2MoveSxWordRegToDWordReg(&RspRecompPos, x86_XMM2, x86_XMM0, IsSse41Enabled);
			Sse2ShuffleDWordsRegToReg(&RspRecompPos, x86_XMM0, x86_XMM0, _MMX_SHUFFLE(3, 2, 3, 2));
			Sse2MoveSxWordRegToDWordReg(&RspRecompPos, x86_XMM0, x86_XMM0, IsSse41Enabled);
			...
			Sse2PadddRegToReg(&RspRecompPos, x86_XMM0, x86_XMM1);
			Sse2PadddRegToReg(&RspRecompPos, x86_XMM2, x86_XMM3);

			Sse2MoveSxWordRegToDWordReg(&RspRecompPos, x86_XMM7, x86_XMM6, IsSse41Enabled);
			Sse2ShuffleDWordsRegToReg(&RspRecompPos, x86_XMM6, x86_XMM6, _MMX_SHUFFLE(3, 2, 3, 2));
			Sse2MoveSxWordRegToDWordReg(&RspRecompPos, x86_XMM6, x86_XMM6, IsSse41Enabled);

			Sse2PadddRegToReg(&RspRecompPos, x86_XMM0, x86_XMM6);
			Sse2PadddRegToReg(&RspRecompPos, x86_XMM2, x86_XMM7);

			Sse2PackSignedDWordRegToWordReg(&RspRecompPos, x86_XMM2, x86_XMM0);
...
static BOOL Compile_Vector_VADD_AVX(BOOL writeToVectorDest, BOOL writeToAccum, BOOL useFlag, BOOL writeToFlag) {
	char Reg[256];
	static VECTOR flagMask;
	static BOOL constInitialized = FALSE;
	...
	if (useFlag) {
		SseMoveAlignedVariableToReg(&RspRecompPos, &flagMask, "flagMask", x86_XMM7, SseType_QuadWord, TRUE);
		AvxVPBroadcastwVariableToReg128(&RspRecompPos, x86_XMM6, &RspVCO, "VCO");
		AvxVPandRegToReg128(&RspRecompPos, x86_XMM6, x86_XMM6, x86_XMM7);
		Sse2CompareEqualWordRegToReg(&RspRecompPos, x86_XMM6, x86_XMM7);
		Sse2PsrlwImmed(&RspRecompPos, x86_XMM6, 15);
	}

	if (writeToAccum) {
		AvxVPAddwRegToReg128(&RspRecompPos, x86_XMM2, x86_XMM0, x86_XMM1);
		if (useFlag) {
			AvxVPAddwRegToReg128(&RspRecompPos, x86_XMM2, x86_XMM2, x86_XMM6);
		}
		SseMoveAlignedRegToVariable(&RspRecompPos, x86_XMM2, &RSP_ACCUM_LOW.UHW[0], "RSP_ACCUM_LOW", SseType_QuadWord, TRUE);
	}
	...
	if (writeToVectorDest) {
		if (useFlag) {
			...
			AvxVPAdddRegToReg256(&RspRecompPos, x86_YMM0, x86_YMM0, x86_YMM1);

			AvxVPMovesxWordReg128ToDwordReg256(&RspRecompPos, x86_YMM6, x86_XMM6);

			AvxVPAdddRegToReg256(&RspRecompPos, x86_YMM0, x86_YMM0, x86_YMM6);
...
void CompileRsp_Vector_VADD ( void ) {
	...
	if (bWriteToDest == FALSE && bWriteToAccum == FALSE && bWriteToFlag == FALSE) {
		return;
	}

	if (bWriteToAccum == FALSE && bFlagUseage == FALSE) {
		if (TRUE == Compile_Vector_VADD_OnlyVec_SSE2(bWriteToFlag))
			return;

		if (TRUE == Compile_Vector_VADD_MMX(bWriteToFlag))
			return;
	}

	if (TRUE == Compile_Vector_VADD_AVX(bWriteToDest, bWriteToAccum, bFlagUseage, bWriteToFlag)) {
		return;
	}

	if (TRUE == Compile_Vector_VADD_SSE2(bWriteToDest, bWriteToAccum, bFlagUseage, bWriteToFlag)) {
		return;
	}
...
static BOOL Compile_Vector_VSUB_SSE2(BOOL writeToVectorDest, BOOL writeToAccum, BOOL useFlag, BOOL writeToFlag) {
	char Reg[256];
	static VECTOR flagMask;
	static BOOL constInitialized = FALSE;
	...
	if (writeToAccum) {
		...
		Sse2PsubwRegToReg(&RspRecompPos, vsreg, x86_XMM1);

		if (useFlag) {
			Sse2PsubwRegToReg(&RspRecompPos, vsreg, x86_XMM6);
		}
	...
	if (writeToVectorDest) {
		if (useFlag) {
			...
			Sse2PsubdRegToReg(&RspRecompPos, x86_XMM0, x86_XMM1);
			Sse2PsubdRegToReg(&RspRecompPos, x86_XMM2, x86_XMM3);

			Sse2MoveSxWordRegToDWordReg(&RspRecompPos, x86_XMM7, x86_XMM6, IsSse41Enabled);
			Sse2ShuffleDWordsRegToReg(&RspRecompPos, x86_XMM6, x86_XMM6, _MMX_SHUFFLE(3, 2, 3, 2));
			Sse2MoveSxWordRegToDWordReg(&RspRecompPos, x86_XMM6, x86_XMM6, IsSse41Enabled);

			Sse2PsubdRegToReg(&RspRecompPos, x86_XMM0, x86_XMM6);
			Sse2PsubdRegToReg(&RspRecompPos, x86_XMM2, x86_XMM7);
			...
			Sse2PsubswRegToReg(&RspRecompPos, x86_XMM0, x86_XMM1);
...
static BOOL Compile_Vector_VSUB_AVX(BOOL writeToVectorDest, BOOL writeToAccum, BOOL useFlag, BOOL writeToFlag) {
	char Reg[256];
	static VECTOR flagMask;
	static BOOL constInitialized = FALSE;
	...
	if (writeToAccum) {
		...
		if (useFlag) {
			AvxVPSubwRegToReg128(&RspRecompPos, x86_XMM2, x86_XMM2, x86_XMM6);
		}
		SseMoveAlignedRegToVariable(&RspRecompPos, x86_XMM2, &RSP_ACCUM_LOW.UHW[0], "RSP_ACCUM_LOW", SseType_QuadWord, TRUE);
	}
	...
	if (writeToVectorDest) {
		if (useFlag) {
			...
			AvxVPSubdRegToReg256(&RspRecompPos, x86_YMM0, x86_YMM0, x86_YMM1);

			AvxVPMovesxWordReg128ToDwordReg256(&RspRecompPos, x86_YMM6, x86_XMM6);

			AvxVPSubdRegToReg256(&RspRecompPos, x86_YMM0, x86_YMM0, x86_YMM6);
...
void CompileRsp_Vector_VSUB ( void ) {
	...
	if (TRUE == Compile_Vector_VSUB_AVX(bWriteToDest, bWriteToAccum, bFlagUseage, bWriteToFlag)) {
		return;
	}

	if (TRUE == Compile_Vector_VSUB_SSE2(bWriteToDest, bWriteToAccum, bFlagUseage, bWriteToFlag)) {
		return;
	}
	...
	for (count = 0; count < 8; count++) {
		...
		if (bFlagUseage == TRUE) {
			...
			SbbX86RegToX86Reg(&RspRecompPos, x86_EAX, x86_EBX);
		} else {
			SubX86RegToX86Reg(&RspRecompPos, x86_EAX, x86_EBX);
		}
...
static BOOL Compile_Vector_VABS_SSE2 (BOOL writeToVectorDest, BOOL writeToAccum) {
	char Reg[256];
	...
	// xmm2 is vt cleared if vs == 0
	Sse2PxorRegToReg(&RspRecompPos, x86_XMM2, x86_XMM2);
	Sse2CompareEqualWordRegToReg(&RspRecompPos, x86_XMM2, x86_XMM0);
	Sse2PandnRegToReg(&RspRecompPos, x86_XMM2, x86_XMM1);

	// xmm1 is neg(vt)
	SseMoveRegToReg(&RspRecompPos, x86_XMM1, x86_XMM2, SseType_QuadWord, TRUE);
	Sse2CompareEqualDWordRegToReg(&RspRecompPos, x86_XMM7, x86_XMM7);
	Sse2PxorRegToReg(&RspRecompPos, x86_XMM1, x86_XMM7);
	Sse2PsrlwImmed(&RspRecompPos, x86_XMM7, 15);

	// xmm0 mask for vs > 0
	Sse2PxorRegToReg(&RspRecompPos, x86_XMM6, x86_XMM6);
	Sse2CompareGreaterWordRegToReg(&RspRecompPos, x86_XMM0, x86_XMM6);

	if (writeToVectorDest == TRUE) {
		int regDest = x86_XMM1;
		if (writeToAccum == TRUE) {
			SseMoveRegToReg(&RspRecompPos, x86_XMM3, x86_XMM1, SseType_QuadWord, TRUE);
			regDest = x86_XMM3;
		}

		Sse2PaddswRegToReg(&RspRecompPos, regDest, x86_XMM7);
		if (IsSse41Enabled == TRUE) {
			Sse41PBlendRegToRegWithXMM0Mask(&RspRecompPos, regDest, x86_XMM2);
		} else {
			if (writeToAccum == TRUE) {
				SseMoveRegToReg(&RspRecompPos, x86_XMM4, x86_XMM0, SseType_QuadWord, TRUE);
				Sse2PandnRegToReg(&RspRecompPos, x86_XMM4, regDest);
				SseMoveRegToReg(&RspRecompPos, x86_XMM5, x86_XMM0, SseType_QuadWord, TRUE);
				Sse2PandRegToReg(&RspRecompPos, x86_XMM5, x86_XMM2);
				Sse2PorRegToReg(&RspRecompPos, x86_XMM4, x86_XMM5);
				regDest = x86_XMM4;
			} else {
				Sse2PandRegToReg(&RspRecompPos, x86_XMM2, x86_XMM0);
				Sse2PandnRegToReg(&RspRecompPos, x86_XMM0, regDest);
				Sse2PorRegToReg(&RspRecompPos, x86_XMM0, x86_XMM2);
				regDest = x86_XMM0;
			}
		}

		sprintf(Reg, "RSP_Vect[%i]", RSPOpC.OP.V.vd);
		SseMoveAlignedRegToVariable(&RspRecompPos, regDest, &RSP_Vect[RSPOpC.OP.V.vd].UHW[0], Reg, SseType_QuadWord, TRUE);
	}

	if (writeToAccum == TRUE) {
		Sse2PaddwRegToReg(&RspRecompPos, x86_XMM1, x86_XMM7);

		if (IsSse41Enabled == TRUE) {
			Sse41PBlendRegToRegWithXMM0Mask(&RspRecompPos, x86_XMM1, x86_XMM2);

			SseMoveAlignedRegToVariable(&RspRecompPos, x86_XMM1, &RSP_ACCUM_LOW.UHW[0], "RSP_ACCUM_LOW", SseType_QuadWord, TRUE);
		} else {
			Sse2PandRegToReg(&RspRecompPos, x86_XMM2, x86_XMM0);
			Sse2PandnRegToReg(&RspRecompPos, x86_XMM0, x86_XMM1);
			Sse2PorRegToReg(&RspRecompPos, x86_XMM0, x86_XMM2);
...
static BOOL Compile_Vector_VABS_AVX(BOOL writeToVectorDest, BOOL writeToAccum) {
	char Reg[256];
	...
	// xmm1 is vt cleared if vs == 0
	Sse2PxorRegToReg(&RspRecompPos, x86_XMM6, x86_XMM6);
	AvxCompareEqualWordRegToReg128(&RspRecompPos, x86_XMM2, x86_XMM6, x86_XMM0);
	AvxVPandnRegToReg128(&RspRecompPos, x86_XMM1, x86_XMM2, x86_XMM1);

	// xmm1 is neg(vt), xmm2 is vt
	SseMoveRegToReg(&RspRecompPos, x86_XMM2, x86_XMM1, SseType_QuadWord, TRUE);
	Sse2CompareEqualDWordRegToReg(&RspRecompPos, x86_XMM7, x86_XMM7);
	Sse2PxorRegToReg(&RspRecompPos, x86_XMM1, x86_XMM7);
	Sse2PsrlwImmed(&RspRecompPos, x86_XMM7, 15);
	...
	if (writeToVectorDest == TRUE) {
		AvxVPAddswRegToReg128(&RspRecompPos, x86_XMM3, x86_XMM1, x86_XMM7);
		AvxVPBlendvbRegToReg128(&RspRecompPos, x86_XMM3, x86_XMM3, x86_XMM2, x86_XMM0);
	...
	if (writeToAccum == TRUE) {
		AvxVPAddwRegToReg128(&RspRecompPos, x86_XMM3, x86_XMM1, x86_XMM7);
		AvxVPBlendvbRegToReg128(&RspRecompPos, x86_XMM3, x86_XMM3, x86_XMM2, x86_XMM0);
...
void CompileRsp_Vector_VABS ( void ) {
	...
	if (TRUE == Compile_Vector_VABS_AVX(bWriteToDest, bWriteToAccum)) {
		return;
	}

	if (TRUE == Compile_Vector_VABS_SSE2(bWriteToDest, bWriteToAccum)) {
		return;
	}
		...
		if (RSPOpC.OP.V.vs == RSPOpC.OP.V.vt && (RSPOpC.OP.V.element & 0xF) < 2) {
			...
			***/
			...
			if (bWriteToAccum == TRUE) {
				...
				/* sign clamp, dest = (regAccum >= 0) ? regAccum : ebx */
				CompConstToX86reg(&RspRecompPos, regAccum, 0);
				CondMoveLess(&RspRecompPos, regAccum, x86_EBX);
...
static BOOL Compile_Vector_VADDC_SSE2(BOOL writeToVectorDest, BOOL writeToAccum, BOOL writeToFlag) {
	char Reg[256];
	static VECTOR flagMask;
	static BOOL constInitialized = FALSE;
	...
	if (writeToFlag == TRUE) {
		Sse2PadduswRegToReg(&RspRecompPos, x86_XMM1, x86_XMM2);
		Sse2CompareEqualWordRegToReg(&RspRecompPos, x86_XMM0, x86_XMM1);
		Sse2CompareEqualDWordRegToReg(&RspRecompPos, x86_XMM1, x86_XMM1);
		Sse2PxorRegToReg(&RspRecompPos, x86_XMM0, x86_XMM1);
		Sse2PandVariableToReg(&RspRecompPos, x86_XMM0, &flagMask, "flagMask");

		if (IsSsse3Enabled == TRUE) {
			...
			SseMoveRegToReg(&RspRecompPos, x86_XMM1, x86_XMM0, SseType_QuadWord, TRUE);
			Sse2ShuffleDWordsRegToReg(&RspRecompPos, x86_XMM1, x86_XMM1, _MMX_SHUFFLE(3, 2, 3, 2));
			Sse2PorRegToReg(&RspRecompPos, x86_XMM0, x86_XMM1);

			SseMoveRegToReg(&RspRecompPos, x86_XMM1, x86_XMM0, SseType_QuadWord, TRUE);
			Sse2ShuffleLowWordsRegToReg(&RspRecompPos, x86_XMM1, x86_XMM1, _MMX_SHUFFLE(3, 2, 3, 2));
			Sse2PorRegToReg(&RspRecompPos, x86_XMM0, x86_XMM1);

			SseMoveRegToReg(&RspRecompPos, x86_XMM1, x86_XMM0, SseType_QuadWord, TRUE);
			Sse2ShuffleLowWordsRegToReg(&RspRecompPos, x86_XMM1, x86_XMM1, _MMX_SHUFFLE(1, 1, 1, 1));
			Sse2PorRegToReg(&RspRecompPos, x86_XMM0, x86_XMM1);
		}
...
static BOOL Compile_Vector_VADDC_AVX(BOOL writeToVectorDest, BOOL writeToAccum, BOOL writeToFlag) {
	char Reg[256];
	static VECTOR flagMask;
	static BOOL constInitialized = FALSE;
	...
	if (writeToFlag == TRUE) {
		Sse2PadduswRegToReg(&RspRecompPos, x86_XMM0, x86_XMM1);
...
void CompileRsp_Vector_VADDC ( void ) {
	...
	if (TRUE == Compile_Vector_VADDC_AVX(bWriteToDest, bWriteToAccum, bWriteToFlag)) {
		return;
	}

	if (TRUE == Compile_Vector_VADDC_SSE2(bWriteToDest, bWriteToAccum, bWriteToFlag)) {
		return;
	}
	...
	for (count = 0; count < 8; count++) {
		...
		if (bWriteToFlag == TRUE) {
			TestConstToX86Reg(&RspRecompPos, 0xFFFF0000, x86_EAX);
			Setnz(&RspRecompPos, x86_EDX);
			if ((7 - el) != 0) {
	...
	if (bWriteToFlag == TRUE) {
		MoveX86regToVariable(&RspRecompPos, x86_ECX, &RspVCO, "RspVCO");
	}
}

static BOOL Compile_Vector_VSUBC_SSE2(BOOL writeToVectorDest, BOOL writeToAccum, BOOL writeToCarryFlag, BOOL writeToNeqFlag) {
	char Reg[256];
	...
	Sse2PsubwRegToReg(&RspRecompPos, x86_XMM0, x86_XMM1);
	...
	if (writeToNeqFlag == TRUE) {
		...
		if (writeToCarryFlag == TRUE) {
			Sse2CompareEqualWordRegToReg(&RspRecompPos, x86_XMM7, x86_XMM0);
			...
			Sse2PandVariableToReg(&RspRecompPos, x86_XMM0, &flagNeqMask, "flagNegMask");
		}
	}

	if (writeToCarryFlag == TRUE) {
		Sse2PsubuswRegToReg(&RspRecompPos, x86_XMM2, x86_XMM1);
		Sse2CompareEqualWordRegToReg(&RspRecompPos, x86_XMM0, x86_XMM2);
		Sse2PxorRegToReg(&RspRecompPos, x86_XMM0, x86_XMM6);
...
void CompileRsp_Vector_VSUBC ( void ) {
	...
	if (bWriteToDest == FALSE && bWriteToAccum == FALSE && bWriteToCarryFlag == FALSE && bWriteToNeqFlag == FALSE) {
		return;
	}
	...
	for (count = 0; count < 8; count++) {
		...
		if (bWriteToNeqFlag == TRUE) {
			TestConstToX86Reg(&RspRecompPos, 0x0000FFFF, x86_EAX);
			Setnz(&RspRecompPos, x86_EDX);
			ShiftLeftSignImmed(&RspRecompPos, x86_EDX, (BYTE)(15 - el));
			OrX86RegToX86Reg(&RspRecompPos, x86_ECX, x86_EDX);
		}

		if (bWriteToNeqFlag == TRUE && bWriteToCarryFlag == TRUE) {
			XorX86RegToX86Reg(&RspRecompPos, x86_EDX, x86_EDX);
		}
		if (bWriteToCarryFlag == TRUE) {
			TestConstToX86Reg(&RspRecompPos, 0xFFFF0000, x86_EAX);
			Setnz(&RspRecompPos, x86_EDX);
			ShiftLeftSignImmed(&RspRecompPos, x86_EDX, (BYTE)(7 - el));
			OrX86RegToX86Reg(&RspRecompPos, x86_ECX, x86_EDX);
...
static BOOL Compile_Vector_VLT_SSE2(BOOL writeToVectorDest, BOOL writeToAccum, BOOL writeToGreaterFlag, BOOL writeToLessFlag, BOOL writeToCarryFlag, BOOL writeToNeqFlag,
									BOOL carryFlagUseage, BOOL neqFlagUseage) {
	char Reg[256];
	static VECTOR VCCGreaterFlagMask;
	static VECTOR VCOFlagMask;
	static BOOL constInitialized = FALSE;

	if (!constInitialized) {
		for (int i = 0; i < 8; ++i) {
			VCCGreaterFlagMask.UHW[i] = 1 << (7 - i);
			VCOFlagMask.UHW[i] = (VCCGreaterFlagMask.UHW[i] << 8) | VCCGreaterFlagMask.UHW[i];
		}
		constInitialized = TRUE;
	}
	...
	if (writeToGreaterFlag == TRUE) {
		SseMoveRegToReg(&RspRecompPos, x86_XMM3, x86_XMM0, SseType_QuadWord, TRUE);
	}
	int dest = x86_XMM2;
	if (writeToVectorDest == TRUE || writeToAccum == TRUE) {
		SseMoveRegToReg(&RspRecompPos, x86_XMM2, x86_XMM0, SseType_QuadWord, TRUE);
		Sse2CompareGreaterWordRegToReg(&RspRecompPos, x86_XMM0, x86_XMM1);
		if (IsSse41Enabled == TRUE) {
			Sse41PBlendRegToRegWithXMM0Mask(&RspRecompPos, x86_XMM2, x86_XMM1);
		} else {
			dest = x86_XMM6;
			SseMoveRegToReg(&RspRecompPos, x86_XMM6, x86_XMM1, SseType_QuadWord, TRUE);
			Sse2PandRegToReg(&RspRecompPos, x86_XMM6, x86_XMM0);
			Sse2PandnRegToReg(&RspRecompPos, x86_XMM0, x86_XMM2);
			Sse2PorRegToReg(&RspRecompPos, x86_XMM6, x86_XMM0);
		}
	}

	if (writeToVectorDest == TRUE) {
		sprintf(Reg, "RSP_Vect[%i]", RSPOpC.OP.V.vd);
		SseMoveAlignedRegToVariable(&RspRecompPos, dest, &RSP_Vect[RSPOpC.OP.V.vd].UHW[0], Reg, SseType_QuadWord, TRUE);
	}

	if (writeToAccum == TRUE) {
		SseMoveAlignedRegToVariable(&RspRecompPos, dest, &RSP_ACCUM_LOW.UHW[0], "RSP_ACCUM_LOW", SseType_QuadWord, TRUE);
	}

	if (writeToGreaterFlag == TRUE) {
		SseMoveRegToReg(&RspRecompPos, x86_XMM0, x86_XMM1, SseType_QuadWord, TRUE);
		Sse2CompareGreaterWordRegToReg(&RspRecompPos, x86_XMM0, x86_XMM3);
		Sse2PandVariableToReg(&RspRecompPos, x86_XMM0, &VCCGreaterFlagMask, "VCCGreaterFlagMask");
		if (carryFlagUseage == TRUE && neqFlagUseage == TRUE) {
			Sse2CompareEqualWordRegToReg(&RspRecompPos, x86_XMM3, x86_XMM1);
			Sse2PandVariableToReg(&RspRecompPos, x86_XMM3, &VCOFlagMask, "VCOFlagMask");
			Sse2MoveDWordVariableToReg(&RspRecompPos, x86_XMM4, &RspVCO, "VCO");
			Sse2ShuffleLowWordsRegToReg(&RspRecompPos, x86_XMM4, x86_XMM4, _MMX_SHUFFLE(0, 0, 0, 0));
			Sse2ShuffleDWordsRegToReg(&RspRecompPos, x86_XMM4, x86_XMM4, _MMX_SHUFFLE(1, 0, 1, 0));
			Sse2PandRegToReg(&RspRecompPos, x86_XMM3, x86_XMM4);
			SseMoveRegToReg(&RspRecompPos, x86_XMM4, x86_XMM3, SseType_QuadWord, TRUE);
			Sse2PsrlwImmed(&RspRecompPos, x86_XMM4, 8);
			Sse2PandRegToReg(&RspRecompPos, x86_XMM3, x86_XMM4);
			Sse2PorRegToReg(&RspRecompPos, x86_XMM0, x86_XMM3);
		}
		...
		Sse2MoveRegToDWordReg(&RspRecompPos, x86_EAX, x86_XMM0);
		MoveX86regToVariable(&RspRecompPos, x86_EAX, &RspVCC, "RspVCC");
	} else if (writeToLessFlag == TRUE) {
...
static BOOL Compile_Vector_VLT_AVX(BOOL writeToVectorDest, BOOL writeToAccum, BOOL writeToGreaterFlag, BOOL writeToLessFlag, BOOL writeToCarryFlag, BOOL writeToNeqFlag,
	BOOL carryFlagUseage, BOOL neqFlagUseage) {
	char Reg[256];
	static VECTOR VCCGreaterFlagMask;
	static VECTOR VCOFlagMask;
	...
	if (writeToVectorDest == TRUE || writeToAccum == TRUE) {
		AvxCompareGreaterWordRegToReg128(&RspRecompPos, x86_XMM2, x86_XMM0, x86_XMM1);
		AvxVPBlendvbRegToReg128(&RspRecompPos, x86_XMM2, x86_XMM0, x86_XMM1, x86_XMM2);
	}
	...
	if (writeToGreaterFlag == TRUE) {
		AvxCompareGreaterWordRegToReg128(&RspRecompPos, x86_XMM3, x86_XMM1, x86_XMM0);
		Sse2PandVariableToReg(&RspRecompPos, x86_XMM3, &VCCGreaterFlagMask, "VCCGreaterFlagMask");
		if (carryFlagUseage == TRUE && neqFlagUseage == TRUE) {
			AvxCompareEqualWordRegToReg128(&RspRecompPos, x86_XMM4, x86_XMM0, x86_XMM1);
			Sse2PandVariableToReg(&RspRecompPos, x86_XMM4, &VCOFlagMask, "VCOFlagMask");
			AvxVPBroadcastwVariableToReg128(&RspRecompPos, x86_XMM5, &RspVCO, "VCO");
			Sse2PandRegToReg(&RspRecompPos, x86_XMM4, x86_XMM5);
			AvxVPSrlwRegToReg128Immed(&RspRecompPos, x86_XMM5, x86_XMM4, 8);
			Sse2PandRegToReg(&RspRecompPos, x86_XMM4, x86_XMM5);
			Sse2PorRegToReg(&RspRecompPos, x86_XMM3, x86_XMM4);
		}

		Ssse3PHorizontalAddRegToReg(&RspRecompPos, x86_XMM3, x86_XMM3);
		Ssse3PHorizontalAddRegToReg(&RspRecompPos, x86_XMM3, x86_XMM3);
		Ssse3PHorizontalAddRegToReg(&RspRecompPos, x86_XMM3, x86_XMM3);

		Sse2MoveRegToDWordReg(&RspRecompPos, x86_EAX, x86_XMM3);
		MoveX86regToVariable(&RspRecompPos, x86_EAX, &RspVCC, "RspVCC");
	}
	else if (writeToLessFlag == TRUE) {
		MoveConstToVariable(&RspRecompPos, 0, &RspVCC, "RspVCC");
...
void CompileRsp_Vector_VLT(void) {
	...
	BOOL bWriteToCarryFlag = WriteToFlag(VCOCarryUsage, RspCompilePC);
	BOOL bWriteToNeqFlag = WriteToFlag(VCONotEqualUsage, RspCompilePC);
	BOOL bCarryFlagUseage = UseRspFlags(VCOCarryUsage, RspCompilePC);
	...
	if (TRUE == Compile_Vector_VLT_AVX(bWriteToDest, bWriteToAccum, bWriteToGreaterFlag, bWriteToLessFlag, bWriteToCarryFlag, bWriteToNeqFlag, bCarryFlagUseage, bNeqFlagUseage)) {
		return;
	}

	if (TRUE == Compile_Vector_VLT_SSE2(bWriteToDest, bWriteToAccum, bWriteToGreaterFlag, bWriteToLessFlag, bWriteToCarryFlag, bWriteToNeqFlag, bCarryFlagUseage, bNeqFlagUseage)) {
		return;
	}
	...
	for (count = 0; count < 8; count++) {
		...
		if (bWriteToDest == TRUE || bWriteToAccum == TRUE) {
			CondMoveGreater(&RspRecompPos, x86_EAX, x86_EBX);
		}
		if (bWriteToGreaterFlag == TRUE) {
			Setl(&RspRecompPos, x86_ECX);
			if (bCarryFlagUseage == TRUE && bNeqFlagUseage == TRUE) {
				Setz(&RspRecompPos, x86_EDX);
			...
			if ((7 - el) != 0) {
				ShiftLeftSignImmed(&RspRecompPos, x86_ECX, (BYTE)(7 - el));
			}
	...
	if (bWriteToGreaterFlag == TRUE) {
		MoveX86regToVariable(&RspRecompPos, x86_ESI, &RspVCC, "RspVCC");
...
static BOOL Compile_Vector_VEQ_SSE2(BOOL writeToVectorDest, BOOL writeToAccum, BOOL writeToGreaterFlag, BOOL writeToLessFlag, BOOL writeToCarryFlag, BOOL writeToNeqFlag, BOOL neqFlagUseage) {
	char Reg[256];
	static VECTOR VCCGreaterFlagMask;
	static BOOL constInitialized = FALSE;
...
void CompileRsp_Vector_VEQ ( void ) {
	...
	if (TRUE == Compile_Vector_VEQ_SSE2(bWriteToDest, bWriteToAccum, bWriteToGreaterFlag, bWriteToLessFlag, bWriteToCarryFlag, bWriteToNeqFlag, bNeqFlagUseage)) {
		return;
	}
...
static BOOL Compile_Vector_VNE_SSE2(BOOL writeToVectorDest, BOOL writeToAccum, BOOL writeToGreaterFlag, BOOL writeToLessFlag, BOOL writeToCarryFlag, BOOL writeToNeqFlag, BOOL neqFlagUseage) {
	char Reg[256];
	static VECTOR VCCGreaterFlagMask;
	static BOOL constInitialized = FALSE;
	...
	if (writeToGreaterFlag == TRUE) {
		Sse2CompareEqualWordRegToReg(&RspRecompPos, x86_XMM0, x86_XMM1);
		Sse2PandnVariableToReg(&RspRecompPos, x86_XMM0, &VCCGreaterFlagMask, "VCCGreaterFlagMask");
...
void CompileRsp_Vector_VNE ( void ) {
	...
	if (TRUE == Compile_Vector_VNE_SSE2(bWriteToDest, bWriteToAccum, bWriteToGreaterFlag, bWriteToLessFlag, bWriteToCarryFlag, bWriteToNeqFlag, bNeqFlagUseage)) {
		return;
	}
	...
	if (bElement == TRUE && bWriteToGreaterFlag == TRUE) {
		del = (RSPOpC.OP.V.element & 0x07) ^ 7;
		sprintf(Reg, "RSP_Vect[%i].HW[%i]", RSPOpC.OP.V.vt, del);
		MoveZxVariableToX86regHalf(&RspRecompPos, &RSP_Vect[RSPOpC.OP.V.vt].HW[del], Reg, x86_EBX);
	}
	...
	for (count = 0; count < 8; count++) {
		...
		if (bElement == FALSE && bWriteToGreaterFlag == TRUE) {
			sprintf(Reg, "RSP_Vect[%i].HW[%i]", RSPOpC.OP.V.vt, del);
			MoveZxVariableToX86regHalf(&RspRecompPos, &RSP_Vect[RSPOpC.OP.V.vt].HW[del], Reg, x86_EBX);
		}
...
static BOOL Compile_Vector_VGE_SSE2(BOOL writeToVectorDest, BOOL writeToAccum, BOOL writeToGreaterFlag, BOOL writeToLessFlag, BOOL writeToCarryFlag, BOOL writeToNeqFlag,
	BOOL carryFlagUseage, BOOL neqFlagUseage) {
	char Reg[256];
	static VECTOR VCCGreaterFlagMask;
	static VECTOR VCOFlagMask;
	...
	// load vs and vt
	sprintf(Reg, "RSP_Vect[%i]", RSPOpC.OP.V.vs);
	SseMoveAlignedVariableToReg(&RspRecompPos, &RSP_Vect[RSPOpC.OP.V.vs].HW[0], Reg, x86_XMM1, SseType_QuadWord, TRUE);

	if ((RSPOpC.OP.V.element & 0xF) < 2) {
		sprintf(Reg, "RSP_Vect[%i]", RSPOpC.OP.V.vt);
		SseMoveAlignedVariableToReg(&RspRecompPos, &RSP_Vect[RSPOpC.OP.V.vt].UHW[0], Reg, x86_XMM0, SseType_QuadWord, TRUE);
	}
	else if ((RSPOpC.OP.V.element & 0xF) >= 8) {
		RSP_Element2Sse(x86_XMM0);
	}
	else {
		RSP_MultiElement2Sse(x86_XMM0);
	}
	...
	if (writeToVectorDest == TRUE || writeToAccum == TRUE) {
		...
		SseMoveRegToReg(&RspRecompPos, x86_XMM3, x86_XMM1, SseType_QuadWord, TRUE);
		if (IsSse41Enabled == TRUE) {
			Sse41PBlendRegToRegWithXMM0Mask(&RspRecompPos, x86_XMM3, x86_XMM2);
		} else {
			dest = x86_XMM4;
			SseMoveRegToReg(&RspRecompPos, x86_XMM4, x86_XMM2, SseType_QuadWord, TRUE);
			Sse2PandRegToReg(&RspRecompPos, x86_XMM4, x86_XMM0);
	...
	if (writeToGreaterFlag == TRUE) {
		SseMoveRegToReg(&RspRecompPos, x86_XMM0, x86_XMM1, SseType_QuadWord, TRUE);
		Sse2CompareGreaterWordRegToReg(&RspRecompPos, x86_XMM0, x86_XMM5);
		Sse2PandVariableToReg(&RspRecompPos, x86_XMM0, &VCCGreaterFlagMask, "VCCGreaterFlagMask");

		if (carryFlagUseage == TRUE || neqFlagUseage == TRUE) {
			Sse2CompareEqualWordRegToReg(&RspRecompPos, x86_XMM5, x86_XMM1);
			Sse2PandVariableToReg(&RspRecompPos, x86_XMM5, &VCOFlagMask, "VCOFlagMask");
			SseMoveRegToReg(&RspRecompPos, x86_XMM7, x86_XMM5, SseType_QuadWord, TRUE);
			Sse2PsrlwImmed(&RspRecompPos, x86_XMM7, 8);
			Sse2MoveDWordVariableToReg(&RspRecompPos, x86_XMM6, &RspVCO, "VCO");
			Sse2ShuffleLowWordsRegToReg(&RspRecompPos, x86_XMM6, x86_XMM6, _MMX_SHUFFLE(0, 0, 0, 0));
			Sse2ShuffleDWordsRegToReg(&RspRecompPos, x86_XMM6, x86_XMM6, _MMX_SHUFFLE(1, 0, 1, 0));
			Sse2PandRegToReg(&RspRecompPos, x86_XMM5, x86_XMM6);
			SseMoveRegToReg(&RspRecompPos, x86_XMM6, x86_XMM5, SseType_QuadWord, TRUE);
			Sse2PsrlwImmed(&RspRecompPos, x86_XMM6, 8);
			Sse2PandRegToReg(&RspRecompPos, x86_XMM5, x86_XMM6);
			Sse2PxorRegToReg(&RspRecompPos, x86_XMM5, x86_XMM7);
			Sse2PorRegToReg(&RspRecompPos, x86_XMM0, x86_XMM5);
		} else {
			Sse2CompareEqualWordRegToReg(&RspRecompPos, x86_XMM5, x86_XMM1);
			Sse2PandVariableToReg(&RspRecompPos, x86_XMM5, &VCCGreaterFlagMask, "VCCGreaterFlagMask");
			Sse2PorRegToReg(&RspRecompPos, x86_XMM0, x86_XMM5);
		}
...
static BOOL Compile_Vector_VGE_AVX(BOOL writeToVectorDest, BOOL writeToAccum, BOOL writeToGreaterFlag, BOOL writeToLessFlag, BOOL writeToCarryFlag, BOOL writeToNeqFlag,
	BOOL carryFlagUseage, BOOL neqFlagUseage) {
	char Reg[256];
	static VECTOR VCCGreaterFlagMask;
	static VECTOR VCOFlagMask;
	...
	if (writeToVectorDest == TRUE || writeToAccum == TRUE) {
		AvxCompareGreaterWordRegToReg128(&RspRecompPos, x86_XMM2, x86_XMM1, x86_XMM0);
		AvxVPBlendvbRegToReg128(&RspRecompPos, x86_XMM3, x86_XMM0, x86_XMM1, x86_XMM2);
	}
	...
	if (writeToGreaterFlag == TRUE) {
		AvxCompareGreaterWordRegToReg128(&RspRecompPos, x86_XMM2, x86_XMM0, x86_XMM1);
		Sse2PandVariableToReg(&RspRecompPos, x86_XMM2, &VCCGreaterFlagMask, "VCCGreaterFlagMask");

		if (carryFlagUseage == TRUE || neqFlagUseage == TRUE) {
			AvxCompareEqualWordRegToReg128(&RspRecompPos, x86_XMM3, x86_XMM0, x86_XMM1);
			Sse2PandVariableToReg(&RspRecompPos, x86_XMM3, &VCOFlagMask, "VCOFlagMask");
			AvxVPSrlwRegToReg128Immed(&RspRecompPos, x86_XMM4, x86_XMM3, 8);
			AvxVPBroadcastwVariableToReg128(&RspRecompPos, x86_XMM5, &RspVCO, "VCO");
			Sse2PandRegToReg(&RspRecompPos, x86_XMM3, x86_XMM5);
			AvxVPSrlwRegToReg128Immed(&RspRecompPos, x86_XMM6, x86_XMM3, 8);
			Sse2PandRegToReg(&RspRecompPos, x86_XMM3, x86_XMM6);
			Sse2PxorRegToReg(&RspRecompPos, x86_XMM3, x86_XMM4);
			Sse2PorRegToReg(&RspRecompPos, x86_XMM2, x86_XMM3);
		}
		else {
			AvxCompareEqualWordRegToReg128(&RspRecompPos, x86_XMM3, x86_XMM0, x86_XMM1);
			Sse2PandVariableToReg(&RspRecompPos, x86_XMM3, &VCCGreaterFlagMask, "VCCGreaterFlagMask");
		...
		Ssse3PHorizontalAddRegToReg(&RspRecompPos, x86_XMM2, x86_XMM2);
		Ssse3PHorizontalAddRegToReg(&RspRecompPos, x86_XMM2, x86_XMM2);
		Ssse3PHorizontalAddRegToReg(&RspRecompPos, x86_XMM2, x86_XMM2);

		Sse2MoveRegToDWordReg(&RspRecompPos, x86_EAX, x86_XMM2);
		MoveX86regToVariable(&RspRecompPos, x86_EAX, &RspVCC, "RspVCC");
	}
	else if (writeToLessFlag == TRUE) {
		MoveConstToVariable(&RspRecompPos, 0, &RspVCC, "RspVCC");
...
void CompileRsp_Vector_VGE ( void ) {
	...
	if (TRUE == Compile_Vector_VGE_AVX(bWriteToDest, bWriteToAccum, bWriteToGreaterFlag, bWriteToLessFlag, bWriteToCarryFlag, bWriteToNeqFlag, bCarryFlagUseage, bNeqFlagUseage)) {
		return;
	}

	if (TRUE == Compile_Vector_VGE_SSE2(bWriteToDest, bWriteToAccum, bWriteToGreaterFlag, bWriteToLessFlag, bWriteToCarryFlag, bWriteToNeqFlag, bCarryFlagUseage, bNeqFlagUseage)) {
		return;
	}
	...
	for (count = 0; count < 8; count++) {
		...
		if (bWriteToGreaterFlag == TRUE) {
			...
			if (bCarryFlagUseage == TRUE || bNeqFlagUseage == TRUE) {
				MoveX86RegToX86Reg(&RspRecompPos, x86_EDX, x86_EBP);
				MoveX86RegByteToX86RegHighByte(&RspRecompPos, x86_EDX, x86_EDX);
				AndVariableToX86Reg(&RspRecompPos, &RspVCO, "RspVCO", x86_EDX);
				AndX86RegHighByteToX86RegByte(&RspRecompPos, x86_EDX, x86_EDX);
				XorX86RegToX86Reg(&RspRecompPos, x86_EDX, x86_EBP);
				AndConstToX86Reg(&RspRecompPos, x86_EDX, 0xFF);
