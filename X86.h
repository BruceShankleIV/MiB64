...
void AdcX86RegToVariableHalf		 ( BYTE** code, void * Variable, char * VariableName, int Source );
...
void AddX86RegToVariableHalf		 ( BYTE** code, void * Variable, char * VariableName, int Source );
